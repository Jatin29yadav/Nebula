...
// Make sure paths are completely lowercase here
const menuItems = [
  { label: "Home", icon: <IoHomeSharp />, href: "/" },
  { label: "Docs", icon: <IoDocumentTextSharp />, href: "/docs" },
  { label: "Explore", icon: <IoPlanetSharp />, href: "/explore" },
  { label: "Blogs", icon: <IoJournalSharp />, href: "/Blogs" },
  { label: "Enlist", icon: <IoRocketSharp />, href: "/enlist" },
    ...
    const handleDown = (e) => {
      ...
      const endDrag = () => {
        ...
        if (activeSegment) {
          ...
          // Use react-router navigate for smooth transitions without page reloads
    ...
    <>
      ...
      <div ref={overlayRef} className="menu-overlay">
        ...
        <div ref={navRef} className="menu-overlay-nav">
          ...
          <div className="menu-overlay-items text-white">
            <a href="#">
          ...
          >
            {segments.map((seg, i) => (
              <Link
                ...
                onClick={() => {
                  // Only close the menu; let the Link component handle the actual routing
                  toggleMenu();
                }}
                style={{
